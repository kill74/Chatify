...
[Icons]
Name: "{autoprograms}\Chatify\Chatify Launcher"; Filename: "{app}\chatify-launcher.cmd"; WorkingDir: "{app}"
...
Name: "{autodesktop}\Chatify"; Filename: "{app}\chatify-launcher.cmd"; WorkingDir: "{app}"; Tasks: desktopicon

[Run]
Filename: "{app}\chatify-launcher.cmd"; Description: "Launch Chatify"; Flags: nowait postinstall skipifsilent
